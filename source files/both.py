...
if __name__ == "__main__":
    ...
    pathFolder = "/Users/user/Desktop/schuhd2/vessel/"
    originFolder = "/Users/user/Desktop/schuhd2/mix/"
    
    filesArray = [x for x in os.listdir(pathFolder) if os.path.isfile(os.path.join(pathFolder,x))]
    
    destinationFolder_P = "/Users/user/Desktop/test_output2/positive/"
    destinationFolder_N = "/Users/user/Desktop/test_output2/negative/"
    destinationFolder_A = "/Users/user/Desktop/test_output2/ambi/"
    destinationFolder_bP = "/Users/user/Desktop/test_output2/testP/"
    destinationFolder_bN = "/Users/user/Desktop/test_output2/testN/"
    destinationFolder_bA = "/Users/user/Desktop/test_output2/testambi/"
    ...
    for file_name in filesArray:
        ...
        elif percent <= 0.02527 and flag==1:      
            print(str(count) + ". 사용가능")
            print(file_name_no_extension)
            print("==================================")
            cv2.imwrite(destinationFolder_P+file_name_no_extension+".jpg",origin)
